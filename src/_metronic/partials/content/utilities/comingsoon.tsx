            ...
            <div className='card-body py-15 py-lg-20'>
              <div className='mb-13'>
                <a href='../../demo1/dist/index.html' className=''>
                  <img
                    alt='Logo'
                    src={toAbsoluteUrl('/media/logos/diasprexicon.svg')}
                    className='h-125px'
                  />
                </a>
              </div>
              <h1 className='fw-bolder text-gray-900 mb-7'>We're Launching Soon</h1>
              <h4>Investment Funds Specially for African Diasporas</h4>
              ...
              <div className='fw-semibold fs-6 text-gray-500 mb-7'>
                Stay tuned by joining our mailing list for updates
              </div>
