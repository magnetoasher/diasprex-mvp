  ...
  return (
    <>
      ...
      <div className='d-flex flex-stack'>
        <div className='me-5'>
          <label className='fs-6 fw-bold form-label'>Save Card?</label>
          <div className='fs-7 fw-bold text-gray-400'>Save card for future funds transfer</div>
        </div>

        <label className='form-check form-switch form-check-custom form-check-solid'>
          <Field className='form-check-input' type='checkbox' value='1' name='saveCard' />
