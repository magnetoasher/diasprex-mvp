...
import {followed, saved, submitted, active, declined } from './ProposalModels'
  ...
  const onChange = (key: string) => {
    ...
    <TabPane
                    ...
                    <div className=' overflow-auto p-3' >
                        {
                        draftprop.map((e) =>
                                <Opportunity name={e.name} userType={e.userType} title={e.title} detail={e.details} column={2} badgeColor="gray" badgeText="Draft" picSrc={e.src} />
                            )
                        }
             ...
             <TabPane
                    ...
                    <div className=' overflow-auto p-3' >
                        {
                            submittedprop.map((e) =>
                                <Opportunity name={e.name} userType={e.userType} title={e.title} detail={e.details} column={2} badgeColor="green" badgeText="Submitted" picSrc={e.src} />
                            )
                        }
