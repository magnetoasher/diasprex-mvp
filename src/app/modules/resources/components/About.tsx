            ...
            <div className='card-body p-lg-17'>
              ...
              <div className='mb-18'>
                ...
                <div className='tns tns-default mb-10'>
                  ...
                  <button onClick={e => this.onGoTo("prev", e)} className='btn btn-icon btn-active-color-primary' id='kt_team_slider_prev'>
                  ...
                  <button onClick={e => this.onGoTo("next", e)} className='btn btn-icon btn-active-color-primary' id='kt_team_slider_next'>
                    <span className='svg-icon svg-icon-3x'>
                      <svg
                        xmlns='http://www.w3.org/2000/svg'
                        width='24'
