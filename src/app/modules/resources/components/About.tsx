    ...
    <div className="card-body p-lg-17">
        <div className="mb-18">
            <div className="mb-10">
                ...
                <div className="overlay">
                    ...
                    <div className="overlay-layer card-rounded bg-dark bg-opacity-25">
                        <a href="../../demo1/dist/pages/pricing/pricing-2.html" className="btn btn-primary">Pricing</a>
            ...
            <div className="fs-5 fw-bold text-gray-600">
                ...
                <a href="../../demo1/dist/pages/blog/post.html" className="link-primary pe-1">Your Post</a>(yes, thinking counts as working if you’re a blogger) before you actually write it.</p>
                ...
                <a href="../../demo1/dist/pages/blog/home.html" className="link-primary pe-1">I mean NOTHING</a>– will kill a blog post more effectively than a lack of enthusiasm from the writer. You can tell when a writer is bored by their subject, and it’s so cringe-worthy it’s a little embarrassing.</p>
        ...
        <div className="card bg-light mb-18">
            <div className="card-body py-15">
                ...
                <div className="fs-2 fw-bold text-muted text-center">
                    <a href="../../demo1/dist/account/security.html" className="link-primary fs-4 fw-bolder">Marcus Levy</a>
            ...
            <div className="row g-10">
                ...
                <div className="col-md-4">
                    <div className="card-xl-stretch mx-md-3">
                        <a className="d-block overlay mb-4" data-fslightbox="lightbox-hot-sales" href="media/stock/600x400/img-74.jpg">
                            <div className="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px" style={{backgroundImage:"url('media/stock/600x400/img-74.jpg')"}}></div>
                            <div className="overlay-layer bg-dark card-rounded bg-opacity-25">
                                <i className="bi bi-eye-fill fs-2x text-white"></i>
                            </div>
                        </a>
                ...
                <div className="col-md-4">
                    <div className="card-xl-stretch ms-md-6">
                        <a className="d-block overlay mb-4" data-fslightbox="lightbox-hot-sales" href="media/stock/600x400/img-47.jpg">
                            <div className="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px" style={{backgroundImage:"url('media/stock/600x400/img-47.jpg')"}}></div>
                            <div className="overlay-layer bg-dark card-rounded bg-opacity-25">
                                <i className="bi bi-eye-fill fs-2x text-white"></i>
                            </div>
                        </a>
        ...
        <div className="mb-18">
            ...
            <div className="tns tns-default mb-10">
                <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000" data-tns-autoplay="true" data-tns-autoplay-timeout="18000" data-tns-controls="true" data-tns-nav="false" data-tns-items="1" data-tns-center="false" data-tns-dots="false" data-tns-prev-button="#kt_team_slider_prev" data-tns-next-button="#kt_team_slider_next" data-tns-responsive="{1200: {items: 3}, 992: {items: 2}}">
                    ...
                    <div className="text-center">
                        <div className="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style={{backgroundImage:"url('media/avatars/300-2.jpg')"}}></div>
                        <div className="mb-0">
                            <a href="#" className="text-dark fw-bolder text-hover-primary fs-3">Melisa Marcus</a>
                            <div className="text-muted fs-6 fw-bold mt-1">Creative Director</div>
                        </div>
                    </div>
                    <div className="text-center">
                        <div className="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style={{backgroundImage:"url('media/avatars/300-5.jpg')"}}></div>
                        <div className="mb-0">
                            <a href="#" className="text-dark fw-bolder text-hover-primary fs-3">David Nilson</a>
                            <div className="text-muted fs-6 fw-bold mt-1">Python Expert</div>
                        </div>
                    </div>
                    <div className="text-center">
                        <div className="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style={{backgroundImage:"url('media/avatars/300-20.jpg')"}}></div>
                        <div className="mb-0">
                            <a href="#" className="text-dark fw-bolder text-hover-primary fs-3">Anne Clarc</a>
                            <div className="text-muted fs-6 fw-bold mt-1">Project Manager</div>
                        </div>
                    </div>
                    <div className="text-center">
                        <div className="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style={{backgroundImage:"url('media/avatars/300-23.jpg')"}}></div>
                        <div className="mb-0">
                            <a href="#" className="text-dark fw-bolder text-hover-primary fs-3">Ricky Hunt</a>
                            <div className="text-muted fs-6 fw-bold mt-1">Art Director</div>
                        </div>
                    </div>
                    <div className="text-center">
                        <div className="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style={{backgroundImage:"url('media/avatars/300-12.jpg')"}}></div>
                        <div className="mb-0">
                            <a href="#" className="text-dark fw-bolder text-hover-primary fs-3">Alice Wayde</a>
                            <div className="text-muted fs-6 fw-bold mt-1">Marketing Manager</div>
                        </div>
                    </div>
                    <div className="text-center">
                        <div className="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style={{backgroundImage:"url('media/avatars/300-9.jpg')"}}></div>
                        <div className="mb-0">
                            <a href="#" className="text-dark fw-bolder text-hover-primary fs-3">Carles Puyol</a>
