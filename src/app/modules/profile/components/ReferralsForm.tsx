      ...
      <Row justify='center'>
        <Col xs={24} sm={24} md={18} lg={18}>
          ...
          >
            ...
            <Form form={form} colon={false} layout='horizontal' onFinish={onSubmit}>
              <Row justify='center'>
                ...
                <Col xs={24} md={24} xl={4} lg={4}>
                  <label style={styleslabel}>Company Name</label>
                </Col>
                <Col xs={24} md={24} xl={19} lg={19}>
                  <Form.Item
                    name='Company_name'
                ...
                <Col xs={24} md={24} xl={4} lg={4}>
                  <label style={styleslabel}>Email Address</label>
                </Col>
                <Col xs={24} md={24} xl={19} lg={19}>
                  <Form.Item
                    name='Email_name'
                ...
                <Divider />
                <Col xs={24} md={24} xl={4} lg={4}>
                  <label style={styleslabel}>Referrel Email</label>
                </Col>
                <Col xs={24} md={24} xl={19} lg={19}>
                  <Form.Item
