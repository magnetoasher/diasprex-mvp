          ...
          <div className='card-body border-top p-9'>
            ...
            {user === "individual" &&
              <>
                ...
                <div className='row mb-6'>
                  <label className='col-lg-4 col-form-label fw-bold fs-6'>
                    <span className='required'>OECD Host Country</span>
                  </label>
                  ...
                  <div className='col-lg-8 fv-row'>
                    <input
                      type='text'
                      className='form-control form-control-lg form-control-solid'
                      placeholder='OECD host country'
                      {...formik.getFieldProps('oecd')}
                    />
                    {formik.touched.oecd && formik.errors.oecd && (
                      <div className='fv-plugins-message-container'>
                        <div className='fv-help-block'>{formik.errors.oecd}</div>
                      </div>
                    )}
                  </div>
                </div>
            ...
            {
              user !== "individual" && <div className='row mb-6'>
                <label className='col-lg-4 col-form-label fw-bold fs-6'>
