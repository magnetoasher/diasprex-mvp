...
const stripePromise = loadStripe('pk_test_51LbV3lIYJnrSpFivcKM3qa8LOtcgawAs9GA6vdVbUBBj46i8DyrQtgLb2Iy3NYlSBmOBNyjLLLWWpxp2AkYpz9eq00aECKRFUs');
...
const Step4: FC = () => {
  ...
  const options = {
    ...
    clientSecret: 'pi_3LbVCqIYJnrSpFiv1690ZodK_secret_QuNj3zT2uZ9PZNy8Mhj0ffIzl',
  };
