                                ...
                                <table className="table fs-6 fw-bold gs-0 gy-2 gx-2 m-0">
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-gray-800 min-w-200px">
                                            <a href="../../demo1/dist/pages/apps/customers/view.html" className="text-gray-800 text-hover-primary">corp@support.com</a>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-gray-800">Floor 10, 101 Avenue of the Light Square, New York, NY, 10050.</td>
                                    </tr>
                            ...
                            <div className="flex-equal">
                                ...
                                <table className="table fs-6 fw-bold gs-0 gy-2 gx-2 m-0">
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-gray-800 min-w-200px">
                                            <a href="#" className="text-gray-800 text-hover-primary text-capitalize">{` ${userTypeFull?.replace("_", " ")} bundle`}</a>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-gray-800">{currentState == "month" ? "Monthly" : "Annually"}</td>
                                    </tr>
                                ...
                                <tbody className="fw-bold text-gray-800">
                                    <tr>
                                        <td>
                                            ...
                                            <div className="fw-normal text-gray-600">{` ${userTypeFull?.replace("_", " ")} bundle`}</div>
                                        </td>
                                        <td>
...
export default AccountVerifiction