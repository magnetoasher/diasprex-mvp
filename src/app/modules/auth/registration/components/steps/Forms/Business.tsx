  ...
  return (
    <div className='w-100'>
      ...
      <div className='fv-row mb-10'>
        ...
        <Field name='orgRegNumber' className='form-control form-control-lg' />
        <div className='text-danger mt-2'>
          <ErrorMessage name='orgRegNumber' />
        </div>
      </div>
      <div className='fv-row mb-10'>
        <label className='form-label required'>Year business registered or incorporated</label>
        <Field name='orgRegYear' className='form-control form-control-lg' />
        <div className='text-danger mt-2'>
          <ErrorMessage name='orgRegYear' />
        </div>
      </div>
      <div className='fv-row mb-10'>
