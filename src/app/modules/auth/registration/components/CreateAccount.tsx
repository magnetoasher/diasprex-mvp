...
import AccountVerifiction from "./steps/AccountVerifiction";
...
const CreateAccount: FC = () => {
  ...
  const questions = {
    individual:
      "Are you a citizen  or a resident of a country in the OECD regions?",
    business:
      "Is your business  located and registered in a country in the OECD region",
    sponsor:
        ...
        <div className="d-flex justify-content-center bg-white rounded justify-content-xl-start flex-row-auto w-100 w-xl-300px w-xxl-400px me-9">
          <div className="px-6 px-lg-10 px-xxl-15 py-20 ">
            <div className="stepper-nav">
              ...
              {/* {userType !== "basic" && ( */}
              <div className={`stepper-item ${hideShow ? "class-hide" : ""}`} data-kt-stepper-element="nav">
                <div className="stepper-line w-40px"></div>
