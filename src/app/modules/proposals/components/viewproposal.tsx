...
const ViewProposal: FC<PropsFromRedux> = (props) => {
  ...
  const badgeColor = propData?.opportunityObject?.open ? 'success' : 'danger'
                ...
                <div className='d-flex flex-wrap justify-content-start'>
                  <div className='d-flex flex-wrap'>
                    ...
                    <div className='border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3'>
                      <div className='d-flex align-items-center'>
                        <div className='fs-4 fw-bold'>
                          {propData?.opportunityObject?.dealtype?.map((deal: string, index: number) =>
                    ...
                    <div className='border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3'>
                      <div className='d-flex align-items-center'>
                        <div className='fs-4 fw-bold'>{propData?.opportunityObject?.following}</div>
                      </div>
