               ...
               <div className="card border border-2 mw-100">
                    ...
                    <div className='row gx-3 d-flex flex-column'>
                        ...
                        <img src={props.flag}
                         ...
                         <div className='menu-content pt-8 pb-2'>
                         <span className='menu-section text-dark text-uppercase fw-bolder fs-2 ls-1'>EDUCATION</span>
                                             </div>
                                             <div className = 'separator mb-3'></div>

                                             <div className = 'mb-6'>
                                                  <p className="fs-6 mb-2 text-dark">{props.grad?.institution}</p>
                                             <p className="fs-6 mb-2 text-muted">{ props.grad?.degree} {props.grad?.field}</p>
                                             </div>
                                             <div className = 'py-1'>
                                                  <p className="fs-6 mb-2 text-dark">{props.undergrad?.institution}</p>
                                             <p className="fs-6 mb-2 text-muted">{props.undergrad?.degree } {props.undergrad?.field}</p>
                    ...
                    <div className="card-body">
                     ...
                     <div className='menu-content pt-4 pb-2'>
                         <span className='menu-section text-dark text-uppercase fw-bolder fs-2 ls-1'>Professional Summary</span>
                         </div>
                          <div className = 'separator mb-3'></div>
...
data-kt-scroll-dependencies="#kt_js_header, #kt_oda_modal, #kt_header"
    ...
    {/* <div id="kt_oda_modal_content">
        ODA content goes here...
                         ...
                         <div className='row'>
                              <div className='menu-content pt-4 pb-2'>
                         <span className='menu-section text-dark text-uppercase fw-bolder fs-2 ls-1'>Professional Interest</span>
                              </div>
                              <div className = 'separator mb-3'></div>
                              <div>
                              <ul className = 'px-10'>
                         ...
                         <div className='row'>
                              <div className='menu-content pt-4 pb-2'>
                         <span className='menu-section text-dark text-uppercase fw-bolder fs-2 ls-1'>Insights</span>
                              </div>
                              <div className = 'separator mb-3'></div>
                              <div>
