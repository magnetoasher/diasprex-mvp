      ...
      <div className='tns tns-default'>
        ...
        >
          <div className='text-center px-5 pt-5 pt-lg-10 px-lg-10'>
            <img
              src={toAbsoluteUrl('/media/product-demos/demo1.png')}
          ...
          <div className='text-center px-5 pt-5 pt-lg-10 px-lg-10'>
            <img
              src={toAbsoluteUrl('/media/product-demos/demo2.png')}
              className='card-rounded shadow mw-100'
              alt=''
            />
          </div>
          ...
          <div className='text-center px-5 pt-5 pt-lg-10 px-lg-10'>
            <img
              src={toAbsoluteUrl('/media/product-demos/demo4.png')}
              className='card-rounded shadow mw-100'
              alt=''
            />
          </div>
          ...
          <div className='text-center px-5 pt-5 pt-lg-10 px-lg-10'>
            <img
              src={toAbsoluteUrl('/media/product-demos/demo5.png')}
              className='card-rounded shadow mw-100'
              alt=''
            />
          </div>
