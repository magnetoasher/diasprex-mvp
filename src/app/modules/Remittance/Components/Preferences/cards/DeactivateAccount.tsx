...
import {IDeactivateAccount, deactivateAccount} from '../PreferencesModel'
import * as Yup from 'yup'
import { useFormik } from 'formik'

const deactivateAccountSchema = Yup.object().shape({
  confirm: Yup.boolean().oneOf([true], 'Please check the box to deactivate your remiitance account'),
})
            ...
            <div className='notice d-flex bg-light-warning rounded border-warning border border-dashed mb-9 p-6'>
              ...
              <div className='d-flex flex-stack flex-grow-1'>
                <div className='fw-bold'>
                  <h4 className='text-gray-800 fw-bolder'>You Are Deactivating Your Remittance Account</h4>
                  <div className='fs-6 text-gray-600'>
                    For extra security, this requires you to contact the admin for any future remittance-related requests
                    <br />
