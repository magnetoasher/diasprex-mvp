        ...
        >
          <div className="row g-5">
            ...
            <div className="col-lg-4">
              <div className="card card-flush bg-light-normal shadow me-2 mb-2 px-10 py-10"
                  data-kt-sticky="true"
          ...
          <div className='fv-row mb-7'>
            ...
            <div className='col-lg-6 fv-row'>
                  ...
                  <div className='col mb-3 text-end'>
                      ...
                      <button className='btn btn-sm btn-primary me-2'>Edit Remittance Details </button>
      ...
      <div className="col-lg-7 shadow">
          ...
          <div className='mb-7'>
            ...
            <div className='d-flex flex-column fv-row'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                {/* end::Label */}
                      ...
                      {/* end::Radio */}
                       {
                          (formik.values.role == 'enabler') && <div className='col d-flex fv-row text-end'>
                        <EnablerTiers />
                            </div>
                       } 
            </div>
            ...
            <div className='d-flex flex-column fv-row'>
              ...
              {/* end::Radio */}
                     ...
                     {
                          (formik.values.role == 'sponsor') && <div className='row d-flex fv-row text-end'>
                        <SponsorTiers />
                            </div>
                       } 
            {/* end::Input row */}
        ...
        <div className='text-center pt-15'>
          ...
          <button
            ...
            disabled={isUserLoading || formik.isSubmitting || !formik.isValid || !formik.touched|| !editUserDetails}
          >
