...
const TablesWidget5: React.FC<Props> = (props:Props) => {
  return (
              ...
              <table className='table table-row-dashed table-row-gray-200 align-middle gs-0 gy-4'>
                ...
                <tbody>
                  <tr>
                    ...
                    <td className='text-end text-muted fw-bold'>Nigeria</td>
                  ...
                  <tr>
                    ...
                    <td className='text-end text-muted fw-bold'>Ghana</td>
                    <td className='text-end'>
                  ...
                  <tr>
                    ...
                    <td className='text-end text-muted fw-bold'>Kenya</td>
                    <td className='text-end'>
                  ...
                  <tr>
                    ...
                    <td className='text-end text-muted fw-bold'>DRC</td>
                    <td className='text-end'>
                  ...
                  <tr>
                    ...
                    <td className='text-end text-muted fw-bold'>Ethiopia</td>
                    <td className='text-end'>
                      <span className='badge badge-light-warning'>In Progress</span>
                    </td>
                    <td className='text-end'>
