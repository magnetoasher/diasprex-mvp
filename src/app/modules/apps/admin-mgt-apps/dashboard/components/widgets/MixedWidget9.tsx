    ...
    <div className={`card ${className}`}>
      ...
      <div className='card-header border-0'>
        <h3 className='card-title align-items-start flex-column'>
          ...
          <span className='text-muted fw-bold fs-7'>Weekly subscription and remittance statistics</span>
        </h3>
            ...
            <div className='col'>
              <div className='d-flex align-items-center me-2'>
                ...
                <div>
                  ...
                  <div className='fs-7 text-muted fw-bold'>Enabler</div>
                </div>
                {/* end::Title */}
              </div>
            </div>
            ...
            <div className='col'>
              <div className='d-flex align-items-center me-2'>
                ...
                <div>
                  ...
                  <div className='fs-7 text-muted fw-bold'>Sponsor</div>
                </div>
                {/* end::Title */}
              </div>
            </div>
          ...
          <div className='row g-0 mt-5 mb-10'>
            ...
            <div className='col'>
              <div className='d-flex align-items-center me-2'>
                ...
                {/* begin::Title */}
                <div>
                  <div className='fs-4 text-dark fw-bolder'>$800M</div>
                  <div className='fs-7 text-muted fw-bold'>Total</div>
                </div>
                {/* end::Title */}
              </div>
            </div>
            ...
            <div className='col'>
              <div className='d-flex align-items-center me-2'>
                ...
                {/* begin::Title */}
                <div>
                  <div className='fs-4 text-dark fw-bolder'>$70M</div>
                  <div className='fs-7 text-muted fw-bold'>Retainer</div>
                </div>
                {/* end::Title */}
              </div>
            </div>
          ...
          <div className='row g-0'>
            ...
            <div className='col'>
              <div className='d-flex align-items-center me-2'>
                ...
                {/* begin::Title */}
                <div>
                  <div className='fs-4 text-dark fw-bolder'>$4.9M</div>
                  <div className='fs-7 text-muted fw-bold'>Average</div>
                </div>
                {/* end::Title */}
              </div>
            </div>
            ...
            <div className='col'>
              <div className='d-flex align-items-center me-2'>
                ...
                {/* begin::Title */}
                <div>
                  <div className='fs-4 text-dark fw-bolder'>$58M</div>
                  <div className='fs-7 text-muted fw-bold'>Total</div>
                </div>
                {/* end::Title */}
              </div>
