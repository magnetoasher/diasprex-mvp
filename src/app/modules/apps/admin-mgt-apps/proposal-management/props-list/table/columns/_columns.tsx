...
import {PropAttachmentCell} from './PropAttachmentCell'
...
const proposalsColumns: ReadonlyArray<Column<Proposal>> = [
  ...
  {
    Header: (props) => (
      <PropCustomHeader tableProps={props} title='Title' className='min-w-125px' />
    ),
    accessor: 'title',
  },
  ...
  {
    Header: (props) => (
      <PropCustomHeader tableProps={props} title='Country' className='min-w-125px' />
    ),
    accessor: 'country',
  },
  ...
  // Begine Admin Screening:: Column
  {
    ...
    id: 'admin_screening',
    Cell: ({...props}) => (
      <PropAdminScreenCell admin_screening={props.data[props.row.index].admin_screening} />
    ),
  },
  ...
  {
    Header: (props) => (
      <PropCustomHeader tableProps={props} title='Attachment' className='min-w-125px' />
    ),
    id: 'attachment',
    Cell: ({...props}) => (
      <PropAttachmentCell attachment={props.data[props.row.index].attachment} />
    ),
  },
